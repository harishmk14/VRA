...
const Sidebar = () => {
  ...
  const navigateTo = (path) => {
    navigate(path);
    setIsSidebarOpen(false); // Close sidebar on navigation (optional)
  };
  ...
  return (
    <div>
      ...
      <div className="md:hidden p-4 flex justify-between items-center bg-white shadow-lg">
      ...
      <div
        ...
        } md:flex flex-col bg-white min-h-screen px-5 shadow-lg sticky top-0 md:w-auto`}
      >
        {/* Logo Section */}
